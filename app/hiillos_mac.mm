...
void executeOnMain(const std::function<void ()>& f) {
    __block std::function<void ()> ff = f;
...
int main(int argc, char* argv[]) {
  ...
  @autoreleasepool {
    ...
    //executeOnMain is a function that is executed on UI context
    CefRefPtr<HiillosApp> app(new HiillosApp(executeOnMain));
